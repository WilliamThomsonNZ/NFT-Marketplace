...
const Page = () => {
    ...
    const buyNfts = async (nft) => {
        ...
        const transaction = await contract.createMarketSale(nftaddres, nft.tokenId, {value: price});
    ...
    return (
        <>
            {isLoading ? <h1>Loading...</h1> : !allListedNfts.length ? <h1>No items in marketplace</h1> : (
                <div>
